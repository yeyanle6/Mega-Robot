...
int main(int argc, char *argv[]) {
  ...
  if (argc < 2) {
    ...
    std::cout
        << "\033[1;33mNo point cloud file path specified; defaulting to the test directory. \033[0m"
        << std::endl;
  } else {
    input_cloud_filepath = argv[1];
    std::cout << "\033[1;32mLoading point cloud files from " << input_cloud_filepath << "\033[0m"
              << std::endl;
  }
